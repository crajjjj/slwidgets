...
Function General()
	...
	AddHeaderOption("Pee And Fart 3")
	Int pafFlag = _getFlag(config.module_paf.isInterfaceActive()) 
	_mme_milk_Toggle = addToggleOption("PAF Pee Icon Enabled", config.module_paf_pee, pafFlag)
	_mme_lactacid_Toggle = addToggleOption("PAF Poop Icon Enabled", config.module_paf_poo, pafFlag)
EndFunction
